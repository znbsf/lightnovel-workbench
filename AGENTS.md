...
4. 如果当前章节或场景指定了局部风味，再读 `01_bible/style_spices/` 中对应文件
5. `01_bible/taboo.md`
6. `02_world/` 中与当前场景相关的文件
7. `03_outline/` 中与当前剧情相关的文件
8. `04_draft/` 中最近一段正文
9. 如果这一场涉及谜团或伏笔，还要读 `05_review/open_loops.md`
...
6. 当用户要求续写章节时，除非明确要求直接出正文，否则先给出场景节拍。
7. 优先一次只写一场戏，而不是一次写完整一章。
8. 如果连续性存在不确定点，先指出问题，再开始写。
